...
from copilot.context import CopilotChatContext, CopilotContext, create_initial_context, public_context
...
def _get_agent_by_name(name: str):
    ...
    agents = {
        ...
        bug_diagnosis_agent.name: bug_diagnosis_agent,
        refactoring_agent.name: refactoring_agent,
        test_generator_agent.name: test_generator_agent,
        security_review_agent.name: security_review_agent,
        documentation_agent.name: documentation_agent,
    }
...
def _build_agents_list() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        make_agent_dict(bug_diagnosis_agent),
        make_agent_dict(refactoring_agent),
        make_agent_dict(test_generator_agent),
        make_agent_dict(security_review_agent),
        make_agent_dict(documentation_agent),
    ]
...
class ConversationState:
    ...
    context: CopilotContext = field(default_factory=create_initial_context)
    current_agent_name: str = triage_agent.name
    events: List[AgentEvent] = field(default_factory=list)
    guardrails: List[GuardrailCheck] = field(default_factory=list)


class CopilotServer(ChatKitServer[dict[str, Any]]):
    ...
    async def respond(
        ...
        try:
            ...
            refusal = "Sorry, I can only answer questions related to software engineering."
